...
const ProjectNotSelected = () => {
  ...
  return (
    <div className="w-3/4 max-w-4x1 flex flex-col items-center">
      ...
      <button
        className="max-w-sx min-w-max px-4 py-2 bg-stone-800 text-stone-100 rounded-md hover:bg-stone-600 focus:bg-stone-900 focus:text-stone-200 font-semibold"
